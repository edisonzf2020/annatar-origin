...
from typing import Any, Optional, Callable, List, Awaitable

import PTT

from annatar.debrid.models import TorrentStreams, Episode, Season
from annatar.debrid.exceptions import ProviderException
from annatar.utils.validation_helper import is_video_file
...
async def select_file_index_from_torrent(
    ...
    file_size_callback: Optional[Callable[[List[dict]], Awaitable[None]]] = None,
) -> int:
